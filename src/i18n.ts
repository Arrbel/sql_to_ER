export const I18N = {
  zh: {
    ...
    historyComment: "显示注释",
    noticeParseHint: "解析提醒",
    noticePartialParse: "已生成，部分语句未解析",
    noticeOperationFailed: "操作失败",
    errEmpty: "输入为空。",
...
`,
  ...
  en: {
    ...
    noticeParseHint: "Parse notice",
    noticePartialParse: "Generated with skipped statements",
    noticeOperationFailed: "Operation failed",
